    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/stok/'.$stok->stok_id) }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <select class="form-control" id="barang_id" name="barang_id" required>
                        ...
                        <option value="{{ $item->barang_id }}" @if($item->barang_id == $stok->barang_id) selected
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <select class="form-control" id="user_id" name="user_id" required>
                        ...
                        <option value="{{ $item->user_id }}" @if($item->user_id == $stok->user_id) selected
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="datetime-local" class="form-control" id="harga_jual" name="stok_tanggal"
